...
keys = [
    ...
    Key([mod], "n", lazy.layout.next(), desc="Switch window focus to next pane"),
    # Move window on the current screen
    Key([mod, "shift"], "h", lazy.layout.shuffle_left(), desc="Shuffle left"),
    Key([mod, "shift"], "l", lazy.layout.shuffle_right(), desc="Shuffle right"),
    ...
    Key([mod, "shift", "control"], "j", lazy.layout.flip_down(), desc="Flip down"),
    Key([mod, "shift", "control"], "k", lazy.layout.flip_up(), desc="Flip up"),
    Key([mod, "shift", "control"], "h", lazy.layout.flip_left(), desc="Flip left"),
    Key([mod, "shift", "control"], "l", lazy.layout.flip_right(), desc="Flip right"),
    Key(
        [mod, "control"],
        "o",
        lazy.layout.grow(),
